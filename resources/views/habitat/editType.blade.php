		...
		<div class="row justify-content-md-center">
			<div class="col-md-4">
				<div class="card atypikcard">
					<form method="POST" action="{{ route('habitat.updateType', $typeActuel->id) }}">
	            		{{ csrf_field() }}
	            		{{ method_field('PUT') }}
						...
						<div class="card-body">
							<ul class="list-group list-group-flush">
								<li class="list-group-item">Nom du type : 
									<input id="typeHabitat" type="text" class="form-control" name="typeHabitat" value="{{ $typeActuel->nom }}" required>
